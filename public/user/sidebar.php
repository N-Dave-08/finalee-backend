...
<aside class="sidebar">
  <?php if ($activePage !== 'update-profile.php' && $activePage !== 'change-password.php'): ?>
    ...
    <nav>
      ...
      <button class="<?=isActive('request-for-new-consultation.php', $activePage)?>" onclick="navigateTo('request-for-new-consultation.php')">REQUEST FOR NEW CONSULTATION</button>
